...
local asciiart = [[
        ...
        __           .__                             ___.   .__          
______ |  | ________ |  | _____  ___.__. ____________\_ |__ |  | ___  ___
\____ \|  |/ /\____ \|  | \__  \<   |  |/  ___/\_  __ \ __ \|  | \  \/  /
|  |_> >    < |  |_> >  |__/ __ \\___  |\___ \  |  | \/ \_\ \  |__>    < 
|   __/|__|_ \|   __/|____(____  / ____/____  > |__|  |___  /____/__/\_ \
|__|        \/|__|             \/\/         \/            \/           \/
  _________               __  .__               ___ ___      ___.        
 /   _____/ ____ ___.__._/  |_|  |__   ____    /   |   \ __ _\_ |__      
 \_____  \_/ ___<   |  |\   __\  |  \_/ __ \  /    ~    \  |  \ __ \     
 /        \  \___\___  | |  | |   Y  \  ___/  \    Y    /  |  / \_\ \    
/_______  /\___  > ____| |__| |___|  /\___  >  \___|_  /|____/|___  /    
        \/     \/\/                \/     \/         \/           \/     
...
if getgenv().hyperlibblock == nil then
    ...
    if getgenv().hyperlibblock == true then
        bigRedItalicText("Another Sycthe Hub instance is already running! Aborting...")
        return
...
local Library = loadstring(game:HttpGet("https://rentry.co/uidrag/raw"))()
getgenv().Window = Library.CreateLib(version, "Sentinel")
...
getgenv().guireloader = GeneralSection:NewButton("Reload Sycthe Hub", "Reloads the Gui with the newest Version", function()
    spawn(function()
...
local usercustom = "Welcome to Sycthe Hub," .. " " .. getLocalPlayerName() .. "!"
local customlen = characterCount(usercustom)
clearChat()
bigRedText(usercustom)
bigRedText(addDashes(customlen))
bigBlueItalicText("Script developed by pkplaysrblx, code used from Hyperlib. Props to Fantemil!")

bigRedText(addDashes(customlen))
bigBlueItalicText("Check out the Project on Github:")
bigGreenItalicText("https://github.com/Fantemil/Hyperlib")
bigGreenItalicText("https://github.com/pkplaysrblx/Sycthe-Hub-Final")
bigRedText(addDashes(customlen))
...
pcall(function()
    if getgenv().hyperlibreload == true then
        ...
        spawn(function()
            wait(0.5)
            bigGreenItalicText("Successfully reloaded Sycthe Hub!")
...
getgenv().ExploitManagerKillAll = ExploitManagerSection:NewButton("Kill all Exploit GUIs",
    "Kills all GUIs that were made after the execution of Sycthe Hub", function()
...
getgenv().ExploitManagerIgnoreAll = ExploitManagerSection:NewButton("Ignore all Exploit GUIs",
    "Ignores all GUIs that were made after the execution of Sycthe Hub", function()
...
StatusSection:NewButton("Copy GitHub Link", "Copies the GitHub Link to your clipboard", function()
    setclipboard("https://github.com/pkplaysrblx/Sycthe-Hub-Final")
...
KeybindsSection:NewKeybind("Toggle UI", "Press T To toggle the Sycthe Hub UI (Click to change Keybind)", Enum.KeyCode.T,
    function()
        Library:ToggleUI()
    end)
